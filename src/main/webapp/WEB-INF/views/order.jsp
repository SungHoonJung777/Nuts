...
<div class="wrapper">
	<div class="wrap">
		...
		<div class="content_area">
			...
			<div class="content_subject"style="background-color: #359381"><span>Order</span></div>
			...
			<div class="content_main">
							...
							<c:forEach items="${orderList}" var="ol">
								<tr>
									...
									<td class="goods_table_price_td">
										<fmt:formatNumber value="${ol.salePrice}" pattern="#,### 원" /> | 수량 ${ol.pillCount}개
										<br><fmt:formatNumber value="${ol.totalPrice}" pattern="#,### 원" />
										<br>[<fmt:formatNumber value="${ol.totalPoint}" pattern="#,### 원" />P]
										<input type="hidden" class="individual_pillPrice_input" value="${ol.pillPrice}">
										<input type="hidden" class="individual_salePrice_input" value="${ol.salePrice}">
										<input type="hidden" class="individual_pillCount_input" value="${ol.pillCount}">
										<input type="hidden" class="individual_totalPrice_input" value="${ol.salePrice * ol.pillCount}">
										...
										<input type="hidden" class="individual_pillId_input" value="${ol.pillId}">
									</td>
								</tr>							
							</c:forEach>
				...
				<div class="total_info_div">
					...
					<div class="total_info_btn_div">
						<a class="order_btn" style="background: #359381">결제하기</a>
					</div>
				</div>				
...
$(document).ready(function(){
	...
	$(".image_wrap").each(function(i, obj){
		...
		if(bobj.data("pillid")){
			...
			$(this).find("img").attr('src', '/resources/product_images/DoctorsBestGumiLutein.jpg');
		}
...
$(".order_btn").on("click", function(){
	...
	$(".goods_table_price_td").each(function(index, element){
		...
		let pillId_input = "<input name='orders[" + index + "].pillId' type='hidden' value='" + pillId + "'>";
		form_contents += pillId_input;
		let pillCount_input = "<input name='orders[" + index + "].pillCount' type='hidden' value='" + pillCount + "'>";
