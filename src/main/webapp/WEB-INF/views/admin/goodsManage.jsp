                    ...
                    <div class="goods_table_wrap">
	                    ...
	                    <c:if test="${listcheck != 'empty'}">
	                    	<table class="goods_table">
	                    		...
	                    		<tr>
	                    			<td><c:out value="${list.pillId}"></c:out></td>
	                    			<td>
	                    				<a class="move" href='<c:out value="${list.pillId}"/>'>
	                    					<c:out value="${list.pillName}"></c:out>
	                    				</a>
	                    			</td>
	                    			<td><c:out value="${list.companyName}"></c:out></td>
	                    			<td><c:out value="${list.cateName}"></c:out></td>
	                    			<td><c:out value="${list.pillStock}"></c:out></td>
...
$(".move").on("click", function(e){
	...
	moveForm.append("<input type='hidden' name='pillId' value='"+$(this).attr("href") + "'>");
